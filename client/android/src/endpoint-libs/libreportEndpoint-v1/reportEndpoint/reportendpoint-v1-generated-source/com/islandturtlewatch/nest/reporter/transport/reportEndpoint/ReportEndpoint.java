...
public class ReportEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public CreateReport createReport(java.lang.Long userId, com.islandturtlewatch.nest.reporter.transport.reportEndpoint.model.ReportRequest content) throws java.io.IOException {
    CreateReport result = new CreateReport(userId, content);
    initialize(result);
    return result;
  }
  ...
  public class CreateReport extends ReportEndpointRequest<com.islandturtlewatch.nest.reporter.transport.reportEndpoint.model.ReportResponse> {
    ...
    private static final String REST_PATH = "createReport/{user_id}";
     ...
     * @since 1.13
     */
    protected CreateReport(java.lang.Long userId, com.islandturtlewatch.nest.reporter.transport.reportEndpoint.model.ReportRequest content) {
    ...
    public CreateReport setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
   ...
   * @return the request
   */
  public GetLatestRefsForUser getLatestRefsForUser(java.lang.Long userId) throws java.io.IOException {
    GetLatestRefsForUser result = new GetLatestRefsForUser(userId);
    initialize(result);
    return result;
  }

  public class GetLatestRefsForUser extends ReportEndpointRequest<com.islandturtlewatch.nest.reporter.transport.reportEndpoint.model.CollectionResponseReportRef> {

    private static final String REST_PATH = "latestRefsForUser/{user_id}";
     ...
     * @since 1.13
     */
    protected GetLatestRefsForUser(java.lang.Long userId) {
    ...
    public GetLatestRefsForUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
