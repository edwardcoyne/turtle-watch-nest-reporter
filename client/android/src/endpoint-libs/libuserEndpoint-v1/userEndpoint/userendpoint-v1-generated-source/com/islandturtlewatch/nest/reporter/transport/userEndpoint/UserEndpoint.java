...
package com.islandturtlewatch.nest.reporter.transport.userEndpoint;
...
public class UserEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_SERVICE_PATH = "userEndpoint/v1/createUser/";
   ...
   * @return the request
   */
  public CreateUser createUser(java.lang.Long userId) throws java.io.IOException {
    CreateUser result = new CreateUser(userId);
    initialize(result);
    return result;
  }

  public class CreateUser extends UserEndpointRequest<com.islandturtlewatch.nest.reporter.transport.userEndpoint.model.CreateUserResponse> {
     ...
     * @since 1.13
     */
    protected CreateUser(java.lang.Long userId) {
      super(UserEndpoint.this, "POST", REST_PATH, null, com.islandturtlewatch.nest.reporter.transport.userEndpoint.model.CreateUserResponse.class);
    ...
    public CreateUser setUserId(java.lang.Long userId) {
      this.userId = userId;
      return this;
    }
