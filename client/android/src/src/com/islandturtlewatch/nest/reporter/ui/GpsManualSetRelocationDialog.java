...
public class GpsManualSetRelocationDialog extends DialogFragment {
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    EditText latEdit = (EditText) getActivity().findViewById(R.id.fieldRelocatedGpsLat);
    final String lat = String.valueOf(latEdit.getText());
    EditText lonEdit = (EditText) getActivity().findViewById(R.id.fieldRelocatedGpsLon);
